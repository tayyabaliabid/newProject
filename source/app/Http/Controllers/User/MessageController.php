...
{ 
    ...
    {
        $messages   = Message::whereUserId(auth()->id())->paginate(10);
        $counter    = 0;   
    ...
    {   
        ...
        $groups      = Group::with('contacts')->whereUserId(auth()->id())->get();
        ...
        return view('user.messages.create', compact('templates', 'contacts'));
    }
