         ...
         <div class="col-sm-12">
             ...
             <div class="card">
                 <div class="card-block">
                     ...
                     <form class="form form-horizontal" action="{{ route('user.settings.update') }}" novalidate method="post" enctype="multipart/form-data">
                         {{ csrf_field() }}
                         ...
                         <div class="form-group">
                             <div class="col-lg-offset-4 col-lg-8">
                                 <a href="{{ route('user.home') }}" class="btn btn-inverse" type="button">Cancel</a>
